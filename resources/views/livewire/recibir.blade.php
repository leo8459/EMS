                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            ...
                                            <button type="button" class="btn btn-warning"
                                                wire:click="recibirAdmision">Recibir Admisión</button>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" wire:model="selectedAdmisiones"
                                                value="{{ $admisione->id }}" wire:key="admision-{{ $admisione->id }}" />
                                        </td>
                                    ...
                                    <form wire:submit.prevent="saveAdmissionData">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                @foreach ($admissionData as $id => $admission)
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                for="observacion_{{ $id }}">Observación</label>
                                                            <textarea id="observacion_{{ $id }}" class="form-control"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary">Guardar y Descargar
                                                    Reporte</button>
                                            </div>
                                        </div>
                                    </form>
