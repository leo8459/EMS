...
<head>
    ...
    <title>Reporte de Admisiones Regionales</title>
    <style>
        body {
...
<body>
    ...
    <h1 class="titulo">Reporte de Admisiones Regionales</h1>
    <p class="fecha">Fecha del reporte: {{ now()->format('d/m/Y H:i') }}</p>
    <table>
        <thead>
            <tr>
                <th>Origen</th>
        ...
        <tbody>
            @foreach ($admisiones as $admision)
                <tr>
                    ...
                    <td>{{ $admision->destino ?? 'No especificado' }}</td> <!-- Agregar un fallback -->
