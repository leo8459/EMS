...
class Recibiradmin extends Component
{
    use WithPagination;
    ...
    {
        // Obtener todos los registros con estado 2
        $admisiones = Admision::where('estado', 2) // Filtrar registros con estado 2
            ->orderBy('fecha', 'desc') // Ordenar por fecha descendente
            ->paginate($this->perPage); // Aplicar paginación
    
        // Almacenar los IDs de la página actual
        $this->currentPageIds = $admisiones->pluck('id')->toArray();
    
        // Retornar la vista con los datos
        return view('livewire.recibiradmin', [
